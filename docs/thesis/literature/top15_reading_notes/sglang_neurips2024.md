...
| **链接** | arXiv:2312.07104v2 / 代码 https://github.com/sgl-project/sglang / 本地 PDF：`docs/research/reference/sglang_neurips2024.pdf` |
| **阅读日期** | 2026-07-23 |
| **状态** | 精读完成 |
...
> ![图 3 · RadixAttention operations（radix tree + LRU）](figs/sglang_fig3.png)
>
> **图 3 · RadixAttention operations（radix tree + LRU）**。对应方法拆解 §3 的 RadixAttention：用 radix tree 索引所有请求的 KV cache 共享前缀，LRU 在叶子淘汰。读图重点：insert / cache-hit / evict 三种操作如何在前缀树上原地完成，前缀复用对应用透明、零手工配置。

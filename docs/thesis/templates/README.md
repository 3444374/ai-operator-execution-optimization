...
- `docs/thesis/templates/硕士生开题报告模板0604.docx`
- `docs/thesis/templates/模板.pptx`
...
正式生成 `docs/thesis/report/opening_report.docx` 时，应从 `硕士生开题报告模板0604.docx` 出发，而不是从空白 Word 文档生成。需要保留或复用模板中的：

...
> `docs/thesis/report/opening_report.md`；当前答辩内容合同是
> `docs/thesis/opening_defense_outline_20260808.md`与`docs/thesis/claim_matrix.md`。
...
![固定资源下的 serving capacity 与过载边界](../../../docs/figures/data/report_main/opening_serving_capacity_frontier.png)
...
![数据组织在不同 serving regime 下的排名变化](../../../docs/figures/data/report_main/opening_work_organization_regime.png)
...
![图像 workload 的 matched-resource 正式对照](../../../docs/figures/data/report_main/opening_image_matched_resource.png)
...
![算子代价模型的选择质量](../../../docs/figures/data/report_main/opening_cost_model_decision_quality.png)

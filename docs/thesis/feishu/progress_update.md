...
- 按学校开题报告模板重排 `docs/thesis/report/opening_report.md`，当前结构包括：课题背景、目的和意义；国内外研究现状；研究目标与研究内容；研究方案与可行性分析；进度安排；预期成果；主要参考文献。
...
- 起草 `docs/thesis/slides/opening_ppt.md`，形成 16 页 PPT 内容源稿，并为每页补充汇报讲稿和答辩备注。
...
- 补全 `docs/thesis/feishu/opening_report_wiki.md`，再同步到飞书“开题报告与开题汇报”wiki。

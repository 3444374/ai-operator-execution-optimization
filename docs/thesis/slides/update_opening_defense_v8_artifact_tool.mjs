...
const FIGURES = [
  "docs/figures/opening_figure_set/main_png/P02_背景_数据库AI算子外部执行链路.png",
  "docs/figures/opening_figure_set/main_png/P03_背景_传统算子与外部AI执行假设.png",
  "docs/figures/opening_figure_set/main_png/P04_相关工作_跨层执行闭环.png",
];

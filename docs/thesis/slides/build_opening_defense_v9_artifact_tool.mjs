...
const SOURCE = path.join(ROOT, "docs/thesis/templates/模板.pptx");
...
const FIG = (name) => path.join(ROOT, "docs/figures/opening_figure_set/main_png", name);
...
const slides = [
  {
    ...
    notes: ["docs/thesis/report/opening_report.md", "docs/thesis/claim_matrix.md"],
  },
  {
    source: 2,
    kind: "agenda",
    ...
    notes: ["docs/thesis/opening_defense_outline_20260808.md"],
  },
  {
    source: 5,
    kind: "wideFigure",
    ...
    notes: ["docs/thesis/report/opening_report.md#1-选题背景与意义"],
  },
  {
    source: 5,
    kind: "wideFigure",
    ...
    notes: ["docs/thesis/report/opening_report.md#2-国内外研究现状"],
  },
  {
    source: 5,
    kind: "wideFigure",
    ...
    notes: ["docs/research/top15_ranked_papers.md", "docs/thesis/report/opening_report.md#2-国内外研究现状", "docs/research/reading_notes/vllm_sosp2023.md", "docs/research/reading_notes/graceful_udf_cost_icde2025.md", "docs/research/reading_notes/costream_icde2024.md", "docs/research/reading_notes/abacus_pvldb2026.md"],
  },
  {
    source: 5,
    kind: "wideFigure",
    ...
    notes: ["docs/thesis/claim_matrix.md#1-冻结题目与系统抽象", "docs/thesis/report/opening_report.md#3-研究目标与关键问题"],
  },
  {
    source: 2,
    kind: "agenda",
    ...
    notes: ["docs/thesis/opening_defense_outline_20260808.md#32-逐页结构"],
  },
  {
    source: 5,
    kind: "wideFigure",
  ...
  },
  {
    ...
    notes: ["docs/thesis/opening_defense_outline_20260808.md#第-10-页实验现象导出四项同等重要的设计要求"],
  },
  {
    source: 2,
    kind: "agenda",
    ...
    notes: ["docs/thesis/report/opening_report.md#4-研究内容与技术路线"],
  },
  {
    source: 5,
    kind: "wideFigure",
    ...
    notes: ["docs/thesis/report/opening_report.md#41-总体系统架构", "docs/figures/opening_figure_set/README.md"],
  },
  {
    source: 5,
    kind: "wideFigure",
    ...
    notes: ["docs/thesis/report/opening_report.md#411-workdescriptor", "code/src/planning/work.py", "code/src/modalities/image/contracts.py"],
  },
  {
    source: 5,
    kind: "wideFigure",
  ...
  },
  {
    ...
    notes: ["docs/thesis/report/opening_report.md#42-研究内容二容量感知的提交路由与多作业调度", "docs/thesis/claim_matrix.md"],
  },
  {
    source: 5,
    kind: "wideFigure",
  ...
  },
  {
    ...
    notes: ["AGENTS.md#1-项目目标", "docs/thesis/report/opening_report.md#44-策略关系与联合验证"],
  },
  {
    source: 2,
    kind: "agenda",
    ...
    notes: ["docs/thesis/report/opening_report.md#6-工作基础与进度安排"],
  },
  {
    source: 5,
    kind: "wideFigure",
    ...
    notes: ["docs/thesis/report/opening_report.md#6-工作基础与进度安排", "docs/thesis/claim_matrix.md"],
  },
  {
    source: 28,
    ...
    notes: ["docs/thesis/report/opening_report.md#62-后续进度安排", "docs/thesis/report/opening_report.md#7-预期成果创新点与风险控制", "docs/thesis/claim_matrix.md"],
  },
  {
    source: 29,
    kind: "thanks",
    ...
    notes: ["docs/thesis/report/opening_report.md"],
  },
];
...
function notesText(index, spec) {
  ...
  return [
    ...
    "",
    "[Sources]",
    ...(spec.notes || ["docs/thesis/report/opening_report.md"]).map((source) => `- ${source}`),
  ].join("\n");
}
...
async function main() {
  ...
  await fs.writeFile(path.join(TMP, "template-audit.txt"), [
    "Source template: docs/thesis/templates/模板.pptx, 29 slides.",

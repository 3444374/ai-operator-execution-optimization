...
const imageBySlide = {
  4: "docs/figures/architecture/existing_ai_operator_execution_chains.png",
  5: "docs/figures/architecture/research_gap_three_islands.png",
  8: "docs/figures/data/report_main/opening_serving_capacity_frontier.png",
  9: "docs/figures/data/report_main/opening_work_organization_regime.png",
  10: "docs/figures/data/report_main/opening_image_matched_resource.png",
  11: "docs/figures/data/report_main/opening_cost_model_decision_quality.png",
  14: "docs/figures/architecture/system_architecture_ai_data_execution.png",
  16: "docs/figures/architecture/data_organization_token_budget_mechanism.png",
  17: "docs/figures/architecture/data_organization_prefix_aware_mechanism.png",
  19: "docs/figures/architecture/runtime_strategy_control_loop.png",
  20: "docs/figures/architecture/submission_control_kmax_admission_mechanism.png",
  25: "docs/figures/architecture/cross_layer_method_framework.png",
};
...
function notesFor(slide) {
  ...
  const sources = {
    ...
    12: "docs/thesis/claim_matrix.md",
  ...
  return [
    ...
    "",
    "[Sources]",
    `- ${sources[slide] || "docs/thesis/report/opening_report.md"}`,
  ].join("\n");
}

...
`docs/thesis/report/opening_report.md`、`docs/thesis/claim_matrix.md` 对齐。
...
```text
docs/thesis/slides/opening_defense_v6_design.md
```
...
当前开题主讲版优先使用 `docs/figures/opening_figure_set/` 的专用图集；权威实验源、可编辑源和复现脚本仍保留在原目录。PPT 生成后仍需用 WPS/PowerPoint 实际打开检查页面布局。
## 2026-07-20 v5

Current PPTX:

```text
docs/thesis/slides/opening_defense_20260720_v5.pptx
```

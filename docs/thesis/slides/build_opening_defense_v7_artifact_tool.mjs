...
const imageBySlide = {
  5: "docs/figures/opening_figure_set/main_png/P05_研究空白_AI数据执行层.png",
  6: "docs/figures/opening_figure_set/main_png/P06_文本基线_执行路径与可比边界.png",
  7: "docs/figures/opening_figure_set/main_png/P07_动机证据_工作量运行状态与容量边界.png",
  8: "docs/figures/opening_figure_set/main_png/P08_图像阶段_准备传输与GPU执行失配.png",
  9: "docs/figures/opening_figure_set/main_png/P09_文本多作业_原生路径并发干扰.png",
  11: "docs/figures/opening_figure_set/main_png/P11_系统架构_数据组织与状态调度闭环.png",
  12: "docs/figures/opening_figure_set/main_png/P12_研究内容一_WorkUnit与数据组织.png",
  13: "docs/figures/opening_figure_set/main_png/P13_数据组织_服务压力与局部性权衡.png",
  14: "docs/figures/opening_figure_set/main_png/P14_研究内容二_状态感知提交与多作业调度.png",
  15: "docs/figures/opening_figure_set/main_png/P15_共享调度_效率隔离与公平权衡.png",
  16: "docs/figures/opening_figure_set/main_png/P16_代价估计_配置选择与决策质量.png",
  17: "docs/figures/opening_figure_set/main_png/P17_图像基线_执行路径与可比边界.png",
  18: "docs/figures/opening_figure_set/main_png/P18_图像多作业_并发干扰.png",
  19: "docs/figures/opening_figure_set/main_png/P19_研究基础与后续工作计划.png",
};
...
const sourceNotes = {
  ...
  4: ["docs/thesis/literature/reading_list.md", "docs/thesis/report/opening_report.md#2-国内外研究现状"],
  5: ["docs/figures/opening_figure_set/main_png/P05_研究空白_AI数据执行层.png", "docs/thesis/claim_matrix.md#1-冻结题目与系统抽象"],
  ...
  11: ["docs/figures/opening_figure_set/main_png/P11_系统架构_数据组织与状态调度闭环.png", "docs/thesis/report/opening_report.md#4-研究内容与技术路线"],
  12: ["docs/figures/opening_figure_set/main_png/P12_研究内容一_WorkUnit与数据组织.png", "code/src/planning/work.py", "code/src/modalities/image/contracts.py"],
  13: ["experiments/results/rc1_data_organization/README.md"],
  14: ["docs/figures/opening_figure_set/main_png/P14_研究内容二_状态感知提交与多作业调度.png", "docs/thesis/claim_matrix.md", "docs/thesis/report/opening_report.md#42-研究内容二容量感知的提交路由与多作业调度"],
  ...
  19: ["docs/figures/opening_figure_set/main_png/P19_研究基础与后续工作计划.png", "docs/thesis/opening_defense_outline_20260808.md#第-19-页主实验用同上限强静态-ab-逐层验证"],
  20: ["docs/thesis/report/opening_report.md#7-预期成果创新点与风险控制"],
};
...
function notesFor(slide) {
  ...
  const sources = sourceNotes[slide] || ["docs/thesis/report/opening_report.md"];
  const talk = {
...
async function main() {
  ...
  await fs.writeFile(path.join(TMP, "deviation-log.txt"), [
    ...
    "Slides 5-9 and 11-19 preserve evidence/architecture image frames and use every approved main figure from docs/figures/opening_figure_set/main_png.",
  ...
  await fs.writeFile(path.join(TMP, "02-evidence-table.txt"), "Authoritative evidence: docs/thesis/claim_matrix.md and docs/figures/opening_figure_set/main_png; underlying experiment sources remain in each slide note.\n", "utf8");

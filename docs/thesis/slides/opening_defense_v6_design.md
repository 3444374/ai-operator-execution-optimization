...
> `docs/thesis/opening_defense_outline_20260808.md`、`docs/thesis/claim_matrix.md`、
> `docs/thesis/report/opening_report.md`和
> `docs/figures/audit/opening_story_figures_contract_20260808.md`。用户已暂停PPT成品，本文件不更新
> 为新版本，也不得据此覆盖云端材料。
...
图内字号、颜色和误差表达以 `docs/figures/audit/opening_core_evidence_figures_contract_20260807.md` 为准。不得在 PPT 内重绘另一套数字。
...
4. 图片使用 `docs/figures/data/report_main/` 的权威 PNG/SVG，不在 `docs/thesis/slides/` 保存副本。

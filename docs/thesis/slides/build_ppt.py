...
# === Paths ===
TEMPLATE = "docs/thesis/templates/模板.pptx"
OUTPUT = "docs/thesis/slides/opening_defense_20260720_v3.pptx"
FIG = "figures"
FIG_CROP = "docs/figures/ppt_cropped"  # Cropped data charts (no titles/captions)

...
| 术语、实验讲解、学习版解释 | `docs/design/history/docs/design/history/learning/experiment_walkthrough.md` |
| 图表文件 | `docs/figures/` |
...
- 解释方式是否参考 `docs/design/history/docs/design/history/learning/experiment_walkthrough.md`。
...
```text
docs/thesis/ppt_rules.md
docs/thesis/report/opening_report.md
docs/figures/README.md
docs/figures/data/selected_motivation_figures.md
```
...
```text
docs/thesis/literature/reading_list.md
...
```text
docs/thesis/assets/README.md
docs/figures/AGENTS.md
docs/figures/audit/figure_plan.md
docs/figures/audit/experiment_charts_audit.md
docs/thesis/ppt_rules.md
```
...
- `docs/thesis/README.md` 是否需要更新入口或状态。
- `docs/thesis/report/opening_report.md` 是否需要同步口径。
- `docs/thesis/report/opening_report.md` 和 `docs/thesis/slides/opening_ppt.md` 是否互相一致。
- `docs/thesis/feishu/` 是否需要同步。
- `docs/thesis/literature/reading_list.md` 是否需要补文献或调整状态。
- `docs/thesis/logs/project_log.md` 是否记录了非实验类修改。

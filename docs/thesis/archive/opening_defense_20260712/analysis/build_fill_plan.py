...
PROJECT = Path("docs/thesis/archive/opening_defense_20260712")
...
plan = {
    ...
    "status": "confirmed",
    "source_pptx": "docs/thesis/templates/opening_ppt_template_version_v6_long_notes_source_checked.pptx",
    "accepted_warnings": [],
    "slides": slides,
}

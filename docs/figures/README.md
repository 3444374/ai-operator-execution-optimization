...
数据来自[容量报告](../../results/postgresql/map_capacity_20260910/README.md)，[审计](audit/map_capacity_20260910.md)说明来源、原始值、失败保留和显示检查。
...
```text
docs/figures/data/report_main/06_gpu_pgai_rerun_granularity_20260714.png
docs/figures/data/report_main/07_gpu_pgai_rerun_stage_writeback_20260714.png
docs/figures/data/report_main/08_gpu_pgai_rerun_endpoint_comparison_20260714.png
...
```text
docs/figures/architecture/data_organization_token_budget_mechanism.png
docs/figures/architecture/data_organization_token_budget_mechanism.svg
docs/figures/architecture/data_organization_length_align_mechanism.png
docs/figures/architecture/data_organization_length_align_mechanism.svg
docs/figures/architecture/data_organization_prefix_aware_mechanism.png
docs/figures/architecture/data_organization_prefix_aware_mechanism.svg
docs/figures/scripts/generate_data_organization_strategy_mechanism.py
docs/figures/audit/data_organization_strategy_mechanism_audit.md
```
...
```text
docs/figures/architecture/submission_control_queue_adaptive_mechanism.png
docs/figures/architecture/submission_control_queue_adaptive_mechanism.svg
docs/figures/architecture/submission_control_kmax_admission_mechanism.png
docs/figures/architecture/submission_control_kmax_admission_mechanism.svg
docs/figures/architecture/submission_control_pool_routing_mechanism.png
docs/figures/architecture/submission_control_pool_routing_mechanism.svg
docs/figures/scripts/generate_submission_control_mechanisms.py
docs/figures/audit/submission_control_strategy_mechanism_audit.md
```
...
做图、改图、迁移图或审查图表前，先读 `docs/figures/AGENTS.md`。本文件只维护当前图资产入口、正式图清单和保留规则。

本目录是项目级图资产库，供 learning 材料、开题报告、开题 PPT、中期汇报和毕业论文共同复用。图不再分散在 `docs/thesis/assets/charts/` 和 `docs/thesis/assets/figures/` 中；后续新增图也优先放在本目录下，并按用途分子目录。
...
`docs/thesis/report/figures/` 以保证报告路径独立、后续转写 Word 方便。报告正文没有继续插入文本
原生多作业、图像 baseline 和图像多作业三张配套图，以控制第 4.2 节图量；选择与图号映射见
`docs/thesis/report/figures/README.md`。副本不构成新的事实源。
...
其中 `docs/figures/` 保留最终图、绘图脚本和图表审计；`results/motivation/` 与 `results/feasibility/` 保留原始 CSV / 结果报告。生成过程中的中间 PNG / SVG 不长期保留。

可以删除或不再使用的旧目录包括：

```text
docs/thesis/assets/charts/python/
docs/thesis/assets/charts/all_meaningful/
docs/thesis/assets/charts/gpu_embed_*.png
docs/thesis/assets/charts/gpu_embed_*.svg
docs/thesis/assets/generate_echarts_experiment_charts.js
docs/thesis/assets/charts/selected/
docs/thesis/assets/figures/system_architecture_ai_data_execution.*
learning/figures/ 中与本目录重复的正式图副本
```

删除前需要确认：

1. `docs/thesis/report/opening_report.md` 不再引用旧图路径。
2. `docs/thesis/feishu/opening_report_wiki.md` 不再引用旧图路径。
3. learning、中期汇报、毕业论文草稿不再引用旧图路径。
4. 开题 PPT 源稿和 PPTX 不再引用旧图路径。
5. 线上飞书文档中的图片已经重新上传为 `docs/figures/data/report_main/` 对应版本。
...
```text
docs/figures/data/report_main/06_gpu_pgai_rerun_granularity_20260714.png
docs/figures/data/report_main/06_gpu_pgai_rerun_granularity_20260714.svg
docs/figures/data/report_main/07_gpu_pgai_rerun_stage_writeback_20260714.png
docs/figures/data/report_main/07_gpu_pgai_rerun_stage_writeback_20260714.svg
docs/figures/data/report_main/08_gpu_pgai_rerun_endpoint_comparison_20260714.png
docs/figures/data/report_main/08_gpu_pgai_rerun_endpoint_comparison_20260714.svg
```

Audit:

```text
docs/figures/audit/pgai_integrated_gpu_rerun_charts_audit_20260714.md
```
...
```text
docs/figures/data/report_main/09_gpu_pgvector_writeback_comparison_20260714.png
docs/figures/data/report_main/09_gpu_pgvector_writeback_comparison_20260714.svg
```

Audit:

```text
docs/figures/audit/pgvector_writeback_chart_audit_20260714.md
```
...
```text
docs/figures/audit/top_venue_strategy_figure_design_notes.md
docs/figures/audit/strategy_figure_micro_design_points.md
docs/figures/audit/local_reference_figure_reading_notes.md
```
...
```text
docs/figures/architecture/runtime_strategy_control_loop.png
docs/figures/architecture/runtime_strategy_control_loop.svg
docs/figures/architecture/runtime_strategy_rule_table.png
docs/figures/architecture/runtime_strategy_rule_table.svg
docs/figures/scripts/generate_runtime_strategy_control_loop.py
docs/figures/audit/runtime_strategy_control_loop_audit.md
```
...
```text
docs/figures/archive/architecture/20260715_strategy_iterations/upstream_strategy_design.png
docs/figures/archive/architecture/20260715_strategy_iterations/upstream_strategy_design.svg
docs/figures/archive/architecture/20260715_strategy_iterations/optimization_strategy_logic.png
docs/figures/archive/architecture/20260715_strategy_iterations/optimization_strategy_logic.svg
docs/figures/archive/architecture/20260715_strategy_iterations/_font_test.png
```
...
docs/figures/data/backup/b07_local_vllm_ray_throughput.svg
docs/figures/data/backup/b08_local_vllm_ray_e2e_time.png
docs/figures/data/backup/b08_local_vllm_ray_e2e_time.svg
docs/figures/data/backup/b09_local_vllm_ray_task_stage_timing.png
docs/figures/data/backup/b09_local_vllm_ray_task_stage_timing.svg
docs/figures/data/backup/b10_local_vllm_request_count_inflight.png
docs/figures/data/backup/b10_local_vllm_request_count_inflight.svg
docs/figures/data/backup/b11_local_vllm_token_tail_performance.png
docs/figures/data/backup/b11_local_vllm_token_tail_performance.svg
...
docs/figures/data/backup/b13_local_vllm_token_tail_penalty.png
docs/figures/data/backup/b13_local_vllm_token_tail_penalty.svg
docs/figures/data/backup/b14_local_vllm_service_tail_gap.png
docs/figures/data/backup/b14_local_vllm_service_tail_gap.svg
...
docs/figures/scripts/generate_local_vllm_ray_baseline_charts.py
```

Audit:

```text
docs/figures/audit/local_vllm_ray_baseline_charts_audit_20260718.md
```

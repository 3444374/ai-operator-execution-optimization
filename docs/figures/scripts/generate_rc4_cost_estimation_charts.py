...
复现:
    .conda/pg-ai-profile/python.exe docs/figures/scripts/generate_rc4_cost_estimation_charts.py
"""
...
def make_5seed_stability_figure(df: pd.DataFrame, output_dir: Path):
    ...
    fig.text(0.5, 0.005,
             ...
             "Source: docs/figures/scripts/generate_rc4_cost_estimation_charts.py",
             ha="center", **NOTE_KW)

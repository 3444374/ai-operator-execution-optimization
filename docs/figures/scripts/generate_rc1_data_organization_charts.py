...
输出三张图到 docs/figures/data/report_main/:
...
每张图附图注说明证据层级与边界。绘图规则遵循 docs/figures/AGENTS.md §5/§11。
...
# 项目四色体系(docs/figures/AGENTS.md §11.1)
...
def make_bfd_scaling_figure(mean_512, std_512, mean_1024, std_1024, output_dir):
    ...
    fig.text(0.5, 0.012,
             ...
             "固定 K_max=8 + immediate flush + fixed_output_cap。Source: docs/figures/scripts/generate_rc1_data_organization_charts.py",
             ha="center", **NOTE_KW)
...
def make_rowcap_slo_figure(mean_512, std_512, mean_1024, std_1024, output_dir):
    ...
    fig.text(0.5, 0.005,
             ...
             "Source: docs/figures/scripts/generate_rc1_data_organization_charts.py",
             ha="center", **NOTE_KW)
...
def main():
    ...
    parser.add_argument("--output-dir", default=None,
                        help="图输出目录。默认 docs/figures/data/report_main/。")

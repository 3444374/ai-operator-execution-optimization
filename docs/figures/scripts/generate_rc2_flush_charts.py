...
输出两张图到 docs/figures/data/report_main/:
...
复现:
    .conda/pg-ai-profile/python.exe docs/figures/scripts/generate_rc2_flush_charts.py
"""
...
def make_three_way_figure(three_way_mean, three_way_std,
    ...
    fig.text(0.5, 0.012,
             ...
             "fixed-25 因过度 flush 导致持续积压。Source: docs/figures/scripts/generate_rc2_flush_charts.py",
             ha="center", **NOTE_KW)
...
def make_cross_rate_heldout_figure(cross_rate_mean, cross_rate_std,
    ...
    fig.text(0.5, 0.005,
             ...
             "2048 held-out 因持续积压放大尾延迟,吞吐较 512 下降 ~10%。Source: docs/figures/scripts/generate_rc2_flush_charts.py",
             ha="center", **NOTE_KW)

...
复现:
    .conda/pg-ai-profile/python.exe docs/figures/scripts/generate_rc2_joint_ablation_charts.py
"""
...
def make_screen_heatmap_figure(screen_mean: pd.DataFrame, output_dir: Path):
    ...
    fig.text(0.5, -0.04,
             ...
             "Source: docs/figures/scripts/generate_rc2_joint_ablation_charts.py",
             ha="center", **NOTE_KW)

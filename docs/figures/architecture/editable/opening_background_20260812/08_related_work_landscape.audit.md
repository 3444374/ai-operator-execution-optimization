...
- Reference: `docs/figures/audit/reference_opening_background_20260812/08_related_work_landscape.png` (1672 × 941).
...
- Local evidence checked before wording changes:
  ...
  - `docs/thesis/literature/top15_reading_notes/` and `docs/research/精读文献笔记/` notes for LOTUS, Galois, IMBridge, Ray Data, Daft, AYO, Parrot, VTC, DLPM, BlendServe, GRACEFUL, COSTREAM and Abacus

...
> 研究内容口径。当前开题研究边界以 `docs/figures/architecture/opening_ai_data_execution_boundary.*`
> 及 `docs/figures/audit/opening_story_figures_contract_20260808.md` 为准；旧图和审计保留用于追溯。
...
- 当前开题报告使用的权威图为 `docs/figures/architecture/editable/02_system_architecture.{drawio,svg,png}`，画布为 1600×900。

...
解决 `docs/figures/data/report_main/` 图过多、文件名无法直接映射到开题页面的问题。依据
`docs/thesis/opening_defense_outline_20260808.md` 与
`docs/figures/audit/opening_required_data_figures_20260810.md`，建立
`docs/figures/opening_figure_set/` 作为开题材料的单一选图入口。
...
`docs/thesis/report/figures/README.md`，权威图源和原审计结论不变。
...
Work Unit、状态反馈、credit/准入/路由等设计，改为 AI 语义算子的通用外部物理执行六阶段流程；P04 只作
...
详细的页码、任务与源文件映射见 `docs/figures/opening_figure_set/README.md`。
...
- 概念图 SVG 使用的独立 icon 同步保存在 `main_svg/assets/`，并由
  `docs/figures/scripts/embed_svg_assets.py` 转为 SVG 内嵌 data URI；因此 SVG 可单文件导入
...
- [x] 原权威文件未移动、未删除；
- [x] 不可比或无正式证据的图未进入图集；
- [x] `docs/figures/README.md`、`PROJECT_INDEX.md`、`PROJECT_OUTLINE.md`、根 `README.md` 与

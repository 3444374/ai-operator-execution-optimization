...
- `docs/figures/architecture/cross_layer_method_framework.png`
- `docs/figures/architecture/cross_layer_method_framework.svg`

Script:

- `docs/figures/scripts/generate_cross_layer_method_framework.py`

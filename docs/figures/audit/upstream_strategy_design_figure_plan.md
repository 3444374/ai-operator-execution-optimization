...
It should not replace `docs/figures/architecture/cross_layer_method_framework.*`. The research-plan figure answers "what is the overall route"; this figure answers "what does the strategy design look like after bottleneck diagnosis".
...
docs/figures/scripts/generate_upstream_strategy_design.py
docs/figures/audit/upstream_strategy_design_audit.md
```

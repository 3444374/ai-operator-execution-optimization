...
**Files:**
- Read: `docs/figures/audit/opening_report_minimal_figure_corrections_design_20260823.md`
- Read: `docs/thesis/report/figures/README.md`
- Read: `docs/figures/opening_figure_set/README.md`
...
```powershell
$paths = @(
  'docs/thesis/report/figures/fig02_ai_data_execution_gap.png',
  'docs/thesis/report/figures/fig03_work_unit_organization.png',
  'docs/thesis/report/figures/fig05_system_architecture.png',
  'docs/thesis/report/figures/fig06_text_baseline_boundaries.png'
)
...
```text
docs/figures/architecture/editable/01_research_gap.drawio
docs/figures/architecture/editable/01_research_gap.svg
docs/figures/architecture/editable/03_work_unit.drawio
docs/figures/architecture/editable/03_work_unit.svg
docs/figures/architecture/editable/02_system_architecture.drawio
docs/figures/architecture/editable/02_system_architecture.svg
docs/figures/data/report_main/opening_text_baseline_evidence_map.svg
docs/figures/scripts/generate_opening_story_figures_20260808.py
```
...
**Files:**
- Modify: `docs/figures/architecture/editable/01_research_gap.drawio`
- Modify: `docs/figures/architecture/editable/01_research_gap.svg`
- Modify: `docs/figures/architecture/editable/01_research_gap.png`
- Modify: `docs/figures/opening_figure_set/editable_drawio/P05_研究空白_AI数据执行层.drawio`
- Modify: `docs/figures/opening_figure_set/main_svg/P05_研究空白_AI数据执行层.svg`
- Modify: `docs/figures/opening_figure_set/main_png/P05_研究空白_AI数据执行层.png`
- Modify: `docs/thesis/report/figures/fig02_ai_data_execution_gap.png`
...
```text
docs/figures/opening_figure_set/editable_drawio/P05_研究空白_AI数据执行层.drawio
```

Copy the authoritative SVG content to:

```text
docs/figures/opening_figure_set/main_svg/P05_研究空白_AI数据执行层.svg
```
...
```text
docs/figures/architecture/editable/01_research_gap.png
docs/figures/opening_figure_set/main_png/P05_研究空白_AI数据执行层.png
docs/thesis/report/figures/fig02_ai_data_execution_gap.png
```
...
**Files:**
- Modify: `docs/figures/architecture/editable/03_work_unit.drawio`
- Modify: `docs/figures/architecture/editable/03_work_unit.svg`
- Modify: `docs/figures/architecture/editable/03_work_unit.png`
- Modify: `docs/figures/opening_figure_set/editable_drawio/P12_研究内容一_WorkUnit与数据组织.drawio`
- Modify: `docs/figures/opening_figure_set/main_svg/P12_研究内容一_WorkUnit与数据组织.svg`
- Modify: `docs/figures/opening_figure_set/main_png/P12_研究内容一_WorkUnit与数据组织.png`
- Modify: `docs/thesis/report/figures/fig03_work_unit_organization.png`
...
**Files:**
- Modify: `docs/figures/architecture/editable/02_system_architecture.drawio`
- Modify: `docs/figures/architecture/editable/02_system_architecture.svg`
- Modify: `docs/figures/architecture/editable/02_system_architecture.png`
- Modify: `docs/figures/opening_figure_set/editable_drawio/P11_系统架构_数据组织与状态调度闭环.drawio`
- Modify: `docs/figures/opening_figure_set/main_svg/P11_系统架构_数据组织与状态调度闭环.svg`
- Modify: `docs/figures/opening_figure_set/main_png/P11_系统架构_数据组织与状态调度闭环.png`
- Modify: `docs/thesis/report/figures/fig05_system_architecture.png`
...
**Files:**
- Modify: `docs/figures/scripts/generate_opening_story_figures_20260808.py`
- Modify: `docs/figures/data/report_main/opening_text_baseline_evidence_map.png`
- Modify: `docs/figures/data/report_main/opening_text_baseline_evidence_map.svg`
- Modify: `docs/figures/opening_figure_set/main_png/P06_文本基线_执行路径与可比边界.png`
- Modify: `docs/figures/opening_figure_set/main_svg/P06_文本基线_执行路径与可比边界.svg`
- Modify: `docs/thesis/report/figures/fig06_text_baseline_boundaries.png`
...
```powershell
$script = Get-Content -Encoding UTF8 -Raw 'docs/figures/scripts/generate_opening_story_figures_20260808.py'
...
& 'C:\Users\Administrator\.cache\codex-runtimes\codex-primary-runtime\dependencies\python\python.exe' `
  'docs/figures/scripts/generate_opening_story_figures_20260808.py' --figures T
```

Confirm the output files are:

```text
docs/figures/data/report_main/opening_text_baseline_evidence_map.png
docs/figures/data/report_main/opening_text_baseline_evidence_map.svg
```
...
Copy the regenerated SVG and PNG to P06, and copy the PNG to `docs/thesis/report/figures/fig06_text_baseline_boundaries.png`.
...
**Files:**
- Modify: `docs/thesis/report/opening_report.md`
- Modify: `docs/thesis/report/opening_report_20260820_qa.md`
- Modify: `docs/thesis/report/figures/README.md`
- Modify: `docs/figures/opening_figure_set/README.md`
- Modify: `docs/figures/audit/opening_figure_set_manifest_20260811.md`
- Modify: `docs/figures/audit/opening_report_minimal_figure_corrections_design_20260823.md`
- Modify: `docs/figures/README.md`
- Modify: `PROJECT_INDEX.md`
- Modify: `docs/thesis/README.md`
- Modify: `docs/thesis/logs/project_log.md`
...
```powershell
$report = Get-Content -Encoding UTF8 'docs/thesis/report/opening_report.md'
...
Select-String -Path 'docs/thesis/report/opening_report.md' -Pattern '产品轨|框架轨|frozen-static|contract|WorkDescriptor \+ 代价估计' -Encoding UTF8
```
...
$taskFiles = @(
  ...
  'docs/figures/architecture/editable/03_work_unit.drawio',
  'docs/figures/architecture/editable/03_work_unit.svg',
  'docs/figures/architecture/editable/03_work_unit.png',
  'docs/figures/architecture/editable/02_system_architecture.drawio',
  'docs/figures/architecture/editable/02_system_architecture.svg',
  'docs/figures/architecture/editable/02_system_architecture.png',
  'docs/figures/scripts/generate_opening_story_figures_20260808.py',
  'docs/figures/data/report_main/opening_text_baseline_evidence_map.png',
  'docs/figures/data/report_main/opening_text_baseline_evidence_map.svg',
  'docs/figures/opening_figure_set',
  'docs/thesis/report/figures',
  'docs/thesis/report/opening_report.md',
  'docs/thesis/report/opening_report_20260820_qa.md',
  'docs/thesis/report/figures/README.md',
  'docs/figures/README.md',
  'PROJECT_INDEX.md',
  'docs/thesis/README.md',
  'docs/thesis/logs/project_log.md'
)

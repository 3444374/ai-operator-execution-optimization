...
**Files:**
- Modify: `docs/thesis/report/opening_report.md:116-188`
...
```powershell
Select-String -Path docs/thesis/report/opening_report.md -Pattern '^## |^### |^#### '
Select-String -Path docs/thesis/report/opening_report.md -Pattern '\[47\]|\[48\]'
```
...
```powershell
$text = Get-Content -Raw -Encoding utf8 docs/thesis/report/opening_report.md
$text -match '基础数据组织'
$text -match '基础调度'
```
...
**Files:**
- Modify: `docs/thesis/report/opening_report.md:184-226`
- Modify: `docs/thesis/report/opening_report.md:314-368`
...
```powershell
Select-String -Path docs/thesis/report/opening_report.md -Pattern '已经|现有|计划|拟|后续'
```
...
**Files:**
- Modify: `docs/thesis/report/opening_report.md:372-464`
...
```powershell
$p = 'docs/thesis/report/opening_report.md'
...
```powershell
Select-String -Path docs/thesis/report/opening_report.md -Pattern '\[47\]|\[48\]'
$missing = Select-String -Path docs/thesis/report/opening_report.md -Pattern '^!\[[^\]]+\]\(([^)]+)\)' | ForEach-Object { Join-Path 'docs/thesis/report' $_.Matches[0].Groups[1].Value } | Where-Object { -not (Test-Path $_) }
$missing
```
...
git diff -- docs/thesis/report/opening_report.md docs/thesis/report/opening_report_20260820_qa.md docs/thesis/README.md docs/thesis/logs/project_log.md PROJECT_LOG.md PROJECT_INDEX.md docs/design/history/superpowers/plans/2026-08-23-opening-report-cost-estimation-enhancement-plan.md
```
...
```powershell
git add -- docs/thesis/report/opening_report.md docs/thesis/report/opening_report_20260820_qa.md docs/thesis/README.md docs/thesis/logs/project_log.md docs/design/history/superpowers/plans/2026-08-23-opening-report-cost-estimation-enhancement-plan.md

# docs/research/reading_notes/ — 泛读笔记库
...
- `figs/` 保留现有笔记引用的历史配图；新精读配图放到对应论文自己的 `docs/figures/` 中。
...
- `docs/thesis/literature/top15_reading_notes/` 是既有开题 Top 15 笔记快照，不随新精读库自动更新。
...
5. 新增或删除笔记后，按根目录规则更新 `docs/research/README.md`、`PROJECT_INDEX.md` 和 `PROJECT_LOG.md`；若 PDF 有变化，同时更新 `REFERENCE_INDEX.md`。

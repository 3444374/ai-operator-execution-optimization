...
对应结果见 [`../../results/system_e2e/opening_text_native_gate_20260808/`](../../../results/system_e2e/opening_text_native_gate_20260808/)
和 [`../../results/system_e2e/opening_text_native_single_job_formal_20260808/`](../../../results/system_e2e/opening_text_native_single_job_formal_20260808/)。
...
- 结果目录：`results/text_native_baseline_formal_<timestamp_commit>/`，保存

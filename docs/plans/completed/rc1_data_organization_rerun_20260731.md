...
> [`../../results/data_organization/rc1_data_organization/`](../../../results/data_organization/rc1_data_organization/)。下文保留预注册合同，
> 不再代表待运行任务。
...
- **存储**：`results/data_organization/rc1_data_organization/<strategy>_<topology>_<date>/{README.md, raw/}`（根 AGENTS §7.5.E）。

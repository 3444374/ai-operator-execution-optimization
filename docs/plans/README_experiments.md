...
当前工程依赖以[架构计划](./postgresql_ai_semantic_operator_architecture_20260827.md)为准：PG 的 choice 与
...
完成度和下一步只看 [`plans/experiment_status_and_gaps.md`](./experiment_status_and_gaps.md)；
真实数字和可引用结论只看
...
| 路径 | 作用 |
|---|---|
| [`plans/`](./) | 当前计划、状态入口与 baseline 总入口 |
| [`plans/completed/`](./completed/) | 已完成且由结果报告接管的预注册合同 |
| [`plans/reference/`](./reference/) | 跨实验协议、检查清单和设计依据 |
| [`plans/archive/`](./archive/) | 被替代、暂停或仅供历史追溯的方案 |

...
证据，不作方法性能排名。权威结果见 `results/system_e2e/opening_database_e2e_text_refeed_20260808/README.md`。
...
- 结果目录：`results/system_e2e/opening_database_e2e_text_20260807/{README.md,raw/}`。

...
```text
results/motivation/pg18_4_fake/simulated_embed_test_20260712.csv
```

GPU profile configuration dry-run:

```text
results/feasibility/gpu_ai_embed_config_dry_run.csv
```
...
The next result that should go into `results/motivation/gpu/` is still:

...
| CSV | `results/motivation/gpu/ai_embed_pgai_integrated_key_20260714.csv` |

The pgai SQL surface was already validated separately in
`results/feasibility/trigger_surface_validation_20260714.md`. The GPU rerun here
...
`results/motivation/gpu/pgvector_writeback_20260714.md`. The same GPU-backed

...
- **raw per-request evidence**（completion_evidence/request_trace/source_scan，含 output_text + 指纹，8192/10570 行数大）保留服务器端 `results/system_e2e/multicard_proj_scale_ramp_formal_20260807/`，未进 git（体积，同 formal sweep raw 排除口径）；可在服务器复核。

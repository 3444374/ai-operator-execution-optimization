...
状态：基础切片与后续[生命周期加固](../query_lifecycle_20260909/README.md)已合入main。
本文保留25c0f090切片的验证与失败记录；后续修复的复测以加固报告为准。
...
[设计与请求预算](../../../docs/plans/postgresql_query_job_design.md)给出范围、来源和停止条件。

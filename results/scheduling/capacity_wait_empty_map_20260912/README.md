...
后续状态：用户于2026-09-14授权服务器测试，[服务器验证已完成](../capacity_wait_server_20260914/README.md)。
下文保留2026-09-12本地阶段及当时的未运行项；当前服务器结果与诊断脚本修复以新报告为准。
...
实施决定见[当前计划](../../../docs/plans/data_organization_batching.md)，

...
python scripts/experiments/run_ai_operator_scenarios.py \
  ../results/scheduling/hol_age_diagnostic_512_20260727/scenario_config.json \
  --result-dir ../results/hol_age_diagnostic_512_20260727
```
...
python scripts/experiments/run_kmax_interference_experiment.py \
  ...
  --repeats 3 --trace-dir ../results/scheduling/hol_age_diagnostic_512_20260727/traces
```

...
内部工程验证，对应[四 D 合同 §8.0](../../../docs/plans/postgresql_semmap_generation_contract.md#80-本次源码复核与首个子切片2026-09-03)。
...
来源和采用理由只保留在上述专项与[主工程对照](../../../docs/plans/postgresql_ai_semantic_operator_architecture_20260827.md#company-engineering-reference)，
未复制、修改或上传公司 demo。

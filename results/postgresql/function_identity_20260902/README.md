...
内部工程验证；对应[主计划工作包六](../../../docs/plans/postgresql_ai_semantic_operator_architecture_20260827.md#carrier-audit-work-package)。
...
工程参照的来源、采用理由与不采用项只记录在[主计划的函数身份切片](../../../docs/plans/postgresql_ai_semantic_operator_architecture_20260827.md#function-identity-slice)。

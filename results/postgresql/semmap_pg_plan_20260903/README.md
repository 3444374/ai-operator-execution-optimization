...
后续实际执行与 main 集成见 [C v5/golden 及合并复核](../semmap_pg_wire_20260903/README.md#merge-review)；
本文件保留接线之前的 plan-only 阶段，不作为当前 Map 能否执行的说明。

## 目的与范围

按[四 D 合同 §3、§8](../../../docs/plans/postgresql_semmap_generation_contract.md)完成 SQL 注册、schema 4
...
`2205ccbbb764e273ee80cede0a2dd1170136f785`。该次验收时分支尚未合入或推送 main。

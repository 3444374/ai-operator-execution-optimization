...
This is the [window-one PG connection](../../../docs/plans/semloom_incremental_session_design.md#pg-map-window-one),
...
[the binding design](../../../docs/plans/postgresql_call_binding_design.md#pg-async-readiness).

...
const raw = path.join(repo, 'results/postgresql/semmap_pg_wire_20260903/raw');
...
const priorPlan = verifyManifest(path.join(repo, 'results/postgresql/semmap_pg_plan_20260903/raw'));

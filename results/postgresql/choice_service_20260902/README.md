...
按[四 C 专项计划 C.5](../../../docs/plans/completed/postgresql_choice_profile_engineering.md#c5-对照请求预算与资源保证)，
...
这不是自动重跑许可。下一项由[主架构计划](../../../docs/plans/postgresql_ai_semantic_operator_architecture_20260827.md)

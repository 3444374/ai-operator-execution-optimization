...
本文件汇总 2026-07-26 完成的全部真实单 GPU 实验的逐批数据分析,按 `learning/AGENTS.md` 的七步结构组织。所有数字直接来自 `results/` 下的真实 CSV(`runs.csv` / `summary_long.csv`),不使用 fake backend。
...
本文件:`results/EXPERIMENT_DATA_ANALYSIS_20260727.md`

### 数据来源(全部真实单 GPU,无 fake)

- `results/output_aware_bfd_{512_v2,1024}_20260726/`
- `results/row_cap_aware_packing_{512/nocache_repeats,1024}_20260726/`
- `results/data_organization/prefix_aware_batching_20260726/screen_v3/`
- `results/scheduling/adaptive_flush_randomized_20260726/{chatml_three_way_512,chatml_flush_formal_512}/`
- `results/scheduling/adaptive_flush_cross_rate_20260726/screen/`
- `results/data_organization/text_heldout_2048_20260726/screen/`
- `results/scheduling/adaptive_admission_controller_20260726/`
- `results/scheduling/shared_vllm_adaptive_admission_20260726/formal_512/`
- `results/data_organization/joint_batching_submission_512_20260726/{screen,candidate_repeat}/`
- `results/cost_estimation/operator_cost_estimation_20260726/`

...
| 配置/原始路径 | 代码 `code/scripts/baselines/squad_capability_gate.py` @ `fd4f8bf`；importer provenance `results/feasibility/squad_v11_dev_import_20260805/provenance.json`（content_hash `2c2301f2…`）；本目录 `report.json` + `per_row_evidence.csv` |

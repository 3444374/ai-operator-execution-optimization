...
| 代码/原始路径 | gate @ `735751b`；importer provenance `results/feasibility/squad_v11_dev_import_20260805/provenance.json`（content_hash `2c2301f2…`）；本目录 `report.json` + `per_row_evidence.csv` + `sample_manifest.jsonl` |

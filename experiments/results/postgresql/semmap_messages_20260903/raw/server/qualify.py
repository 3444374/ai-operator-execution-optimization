"""Qualify one clean message-compilation commit using isolated PG18.3 fixtures."""
import argparse
import hashlib
import json
import os
...
for source in ("generation_profile", "sem_operator_machine", "sem_filter_machine", "sem_map_machine", "sem_message_writer"):

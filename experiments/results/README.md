...
| Directory | Content | Boundary |
|---|---|---|
| `adaptive_flush_randomized_20260726/` | Natural-EOS gate, randomized 512-request fixed-25 vs queue-adaptive repeats, exact output-token/finish tracing, and a fixed-50 mechanism probe. | Adaptive is clearly better than fixed-25, but the evidence does not show it beats the best static timeout. |

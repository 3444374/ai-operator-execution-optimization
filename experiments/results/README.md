...
| `saor_active_set_release_formal_20260812_69affc7e/` | fixed-envelope 2-Job 六 active-set 臂 + 四 matched-solo，1+3 formal | 40/40、0 incident、exactly-once；SAOR 在 credit 臂内 fg JCT/P99 最好，但 static 显著更强。原始完整 gate 因 DRR/VTC rep2 无 post-drain 样本而 fail-closed；250 ms resolution-aware compact replay effective 12/12，但明确不升级完整 validation。 |

...
| `state_aware_work_unit/saor_bounded_ready_gate_20260813/` | 同 selector、改为有界 concrete-ready 预注册后的两轮四臂 development gate | 8/8 cell、0 incident；$0.125W_e$ 两轮全过，均值 12,361 tok/s、fg P99 17.87s、fg SLO 0%、bulk 30s miss 0.662；$0.25W_e$ 被拒绝。候选需先过 matched-observation 归因门，formal 尚未运行。 |

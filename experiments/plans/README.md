...
| [`postgresql_choice_profile_engineering.md`](postgresql_choice_profile_engineering.md) | 四 C 进行中：PG choice SELECT 已接通 C/gateway，资源/真实模型待验证；字段、错误、兼容性、预算和资源验收的唯一详细入口 |

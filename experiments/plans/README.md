...
| 生成型 Map 的具体行为、数据表示与验收 | [`postgresql_semmap_generation_contract.md`](postgresql_semmap_generation_contract.md)：四 D 合同定稿，待研发核对代码落点与实施 |
...
| [`postgresql_semmap_generation_contract.md`](postgresql_semmap_generation_contract.md) | 四 D 生成型 Map 合同定稿：SQL/prompt/输出、版本和测试预期；仍待研发核对代码落点、实现及 PG/资源/模型验证 |

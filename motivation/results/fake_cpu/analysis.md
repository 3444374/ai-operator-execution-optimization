...
```text
motivation/results/fake_cpu/granularity.csv
```
...
```text
motivation/results/fake_cpu/backpressure.csv
```
...
| 类型 | 文件 | 用途 |
|---|---|---|
| 连接验证 | `feasibility/results/pg18_4_connection_validation.md` | 只说明本地 PG18.4 + pgvector 可连接，项目脚本能读写数据库 |
| 系统画像 / 瓶颈定位 | `motivation/results/pg18_4_fake/system_profile.md` | 说明 PG18.4 真实数据库触发链路中的瓶颈、可优化点和下一步 baseline |
| 系统画像原始数据 | `motivation/results/pg18_4_fake/system_profile.csv` | 4096 行 formal CSV，含 warm-up/formal、python/ray_actor、fine/coalesced |

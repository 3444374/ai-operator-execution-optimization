...
本实验延续 `pg18_4_baseline_matrix.md`，专门验证上一轮发现的写回成本：
...
```text
motivation/results/pg18_4_vector_writeback.csv
```
...
$out = 'motivation\results\pg18_4_vector_writeback.csv'
...
3. scaling 完成后再接真实 CPU embedding 小模型，验证 fake invocation / batch 信号是否迁移。

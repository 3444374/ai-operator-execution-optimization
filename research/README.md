...
| `精读文献笔记/` | 精读笔记权威库；当前 LOTUS、Galois、AYO、Cortex AISQL、Ray Data、Ray OSDI 2018、BlendServe、Relational LLM Queries 与 VTC 九篇主笔记共含 74 张论文原图裁剪件；各篇选图与版本边界见目录 README 和 `figures/audit/` |

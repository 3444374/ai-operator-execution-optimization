...
| `saor_model_scenario_audit_20260811.md` | SAOR capacity-only 负结果后的数学审计：fixed-envelope ordered release 主方法、可选 Safe-Capacity Governor、oracle 证明骨架、公平合同与独立 benchmark/淘汰门 |

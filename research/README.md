...
| `精读文献笔记/` | 精读笔记权威库；当前 LOTUS、Galois、Palimpzest、Abacus、Sema、AYO、Cortex AISQL、Ray Data、Ray OSDI 2018、BlendServe、Relational LLM Queries、VTC、IMBridge、DLPM 与 Parrot 十五篇主笔记共含 134 张论文原图裁剪件；各篇选图与版本说明见目录 README 和 `figures/audit/` |

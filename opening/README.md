...
| 开题报告 Word 版 | `report/数据库_AI_负载的执行优化与调度研究_开题报告.docx` | 严格沿用学校 Word 模板的 A4 版心、封面、页脚页码和签字页；正文按宋体/Times New Roman、小四、1.5 倍行距排版，一级标题四号黑体、其余标题小四黑体、图注五号黑体，含 16 张正文图片和 53 条参考文献；学号、专业和指导教师留待填写 |

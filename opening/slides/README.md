...
## 2026-08-12 v7（当前 20 页中文主讲版）

当前 PPTX：`opening_defense_20260812_v7.pptx`。该版本继承 v6 学校模板的母版、页眉页脚和
...
当前版本已完成 20/20 页渲染、图文一致性审计、空 placeholder、speaker notes 和模板保真
检查。正式图的比较合同与 `../claim_matrix.md` 一致；第 2、3 页的可选增强图提示词记录在
`opening_defense_20260812_v7_figure_content_audit.md`，无需等待补图即可使用当前版本。

...
[最新M1复测](experiments/results/postgresql/m1_supply_followup_20260920/README.md)修复了重复容量汇总开销，但真实C64查询失败后停止；修复与证据仍在分支，未合入main。
...
main已按 planner、semantics、executor 和 provider 整理现有实现；本地检查和PG18.3完整重验已通过，源码入口见[模块说明](code/postgres/semloom_pg/README.md#module-layout)。

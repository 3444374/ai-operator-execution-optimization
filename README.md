...
`codex/pg-module-layout` 分支按 planner、semantics、executor 和 provider 整理现有实现；本地检查和PG18.3完整重验已通过，尚未合并main，源码入口见[模块说明](code/postgres/semloom_pg/README.md#module-layout)。

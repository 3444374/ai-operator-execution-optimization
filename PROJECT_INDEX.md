...
| `code/scripts/experiments/run_saor_native_system_matched.py` | 本地系统级 matched matrix 编排与 readiness/执行器绑定 fail-closed 入口 | `--rehearsal` 只跑 warm-up；非 rehearsal 必须在任何输出/lease/executor 副作用前验证独立 authorization artifact，当前 GPU/formal 停止 |

...
| `experiments/results/state_aware_work_unit/saor_feeding_gap_diagnostic_rerun_20260818/` | 08-18 全新 root 完整重跑的 D0/D1/P0 判决报告与 compact evidence；前置三轮 transport gate（BrokenPipeError 竞态定位）与结构化错误补丁 `2e4c2723` | 12/12 cell、0 incident；`valid_diagnostic / work_envelope_primary`：D1/D0=0.9238、P0/D1=0.9982——W envelope 主导差距，Project 路径损失 0.18%。`locked_failed_feeding` 不变；下一步按 exit contract 拆实现效率/保护成本两道门 |

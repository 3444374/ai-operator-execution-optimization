...
| `deploy/autodl/saor_project_mechanism_formal_contract.json` | VTC-style 主参照、5% headline、吞吐/JCT/SLO/no-service 非劣、固定输出上界与 30s empirical repayment 的预注册决策合同 | `locked_pending_formal_readiness/formal_authorized=false`；独立审核已登记并逐字段绑定，待当前签名 feeding ceiling |

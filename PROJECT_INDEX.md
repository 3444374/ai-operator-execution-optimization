...
| `feasibility/results/image_staged_resource_gate_20260802/` | Daft/Ray Data staged 256-row双卡显式资源与输出等价门禁 | 确认 SQL reader 不再被常驻 actor 饿死、schema v4 CPU 账本正确；不能把单次冷启动吞吐用于系统排名 |

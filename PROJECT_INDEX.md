...
| `experiments/results/EXPERIMENT_EVIDENCE_REGISTRY.md` | Unified map from every implemented/tested mechanism to code, tests, all 20 result directories, evidence level, current decision, and remaining validation | Read first when asking what has actually been implemented, tested, proven, rejected, or left unverified |

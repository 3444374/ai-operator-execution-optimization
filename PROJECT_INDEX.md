...
| `experiments/results/vllm_cuda_graph_512_20260726/` | Eager vLLM service record, validated configs, passed 64-request gate, and three audited 512 formal repeats | Use as the eager-side baseline while retaining the recovered schema incident and Ray shutdown stderr concern; compare only after the graph arm is captured |

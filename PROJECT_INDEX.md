...
| 单流增量执行近期规格 | [详细设计](experiments/plans/semloom_incremental_session_design.md) | 方法续体、组织窗口、增量核心及受限生成Map的PG多在途已验证；[最新接入证据](experiments/results/postgresql/async_window_20260908/README.md)；Filter/组合、单请求多成员和多活动session待实现 |

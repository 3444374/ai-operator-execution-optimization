...
| `opening/slides/opening_defense_v6_design.md` | 开题答辩 PPT v6 设计说明 | Defines the evidence-first full deck, skip-page structure, top-venue architecture figures, content corrections, synchronization scope, and QA gates before editing the PPTX |

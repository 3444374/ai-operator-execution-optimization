...
| `experiments/results/state_aware_work_unit/saor_bounded_priority_gate_20260813/` | v0.5.1 static/SAOR/$0.125W_e$/$0.25W_e$ 双轮 GPU development gate、lossless event 与请求时序交叉验证 | 两 cap 均未过 fg 门；$0.25W_e$ 第 2 轮无 debt recovery 被 fail-closed。定位完整 ready-backlog 模型与每 Job 单-head pull 实现不一致；不启动 formal/4-Job/reservation |

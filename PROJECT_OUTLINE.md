...
后续[M1复测](experiments/results/postgresql/m1_supply_followup_20260920/README.md)定位了重复容量汇总的CPU开销，受控修复通过；真实C64预热出现两项未确认执行后停止，尚无完整筛查、选点或方法结果。代码与证据留在复测分支，暂不合入main。

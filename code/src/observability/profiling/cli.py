...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        "--token-budget-policy",
        choices=["static", "service_quantum"],
        default="static",
    )
    parser.add_argument(
        "--token-budget-candidates",
        default="2048,4096,8192,16384",
        help="Comma-separated safe budgets calibrated by the static curve.",
    )
    parser.add_argument(
        "--token-budget-target-service-ms",
        type=float,
        default=2000.0,
    )
    parser.add_argument(
        "--token-budget-arrival-ewma-alpha",
        type=float,
        default=0.3,
    )
    ...
    parser.add_argument(
        ...
        default=0,
        help=(
            "Optional prompt+estimated-output work credit per endpoint; "
    ...
    parser.add_argument(
        ...
        default="ai-operator-scheduling",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        choices=["drr", "fifo", "vtc", "saor", "strict_priority"],
        default="drr",
    )
    ...
    parser.add_argument("--flush-ewma-alpha", type=float, default=0.3)
    parser.add_argument("--flush-deadband-ratio", type=float, default=0.1)
    parser.add_argument(

"""CLI parsing shared by the thin shared-vLLM experiment entrypoints."""
...
def parse_runner_args(argv: list[str] | None = None) -> RunnerOptions:
    """Parse the common shared-vLLM runner contract."""
